    ...
    <Layout>
      ...
      <Wrapper>
        <MarqueeContainer isMobile={isMobile}>
          <Marquee gradientColor={[18, 18, 18]} speed={isMobile ? 325 : 150} style={{ height: 50 }}>
            <img src={ArrowBlue} alt="Arrow" style={{ maxWidth: 50, maxHeight: 50 }} />
            <div style={{ width: 400 }}></div>
          </Marquee>
          <Marquee gradientColor={[18, 18, 18]} speed={isMobile ? 300 : 100} style={{ marginTop: 30, height: 100 }}>
            <img src={Arrow} alt="Arrow" style={{ maxWidth: 100, maxHeight: 100 }} />
            <div style={{ width: 400 }}></div>
          </Marquee>
          <Marquee gradientColor={[18, 18, 18]} speed={isMobile ? 225 : 75} style={{ marginTop: 20, height: 75 }}>
            <img src={Arrow} alt="Arrow" style={{ maxWidth: 75, maxHeight: 75 }} />
            <div style={{ width: 400 }}></div>
          </Marquee>
          <Marquee gradientColor={[18, 18, 18]} speed={isMobile ? 310 : 125} style={{ marginTop: 40, height: 60 }}>
            <img src={ArrowBlue} alt="Arrow" style={{ maxWidth: 60, maxHeight: 60 }} />
            <div style={{ width: 400 }}></div>
          </Marquee>
          <Marquee gradientColor={[18, 18, 18]} speed={isMobile ? 180 : 60} style={{ marginTop: 30, height: 125 }}>
